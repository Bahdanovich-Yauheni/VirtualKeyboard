...
document.querySelector('.keyboard').addEventListener('mousedown', (event) => {
    ...
    if (divKey.classList.contains('key')){
...
let arrayOfBtnCodes = ["Backquote", "Digit1", "Digit2", "Digit3", "Digit4", "Digit5", "Digit6", "Digit7", "Digit8", "Digit9", "Digit0", "Minus", "Equal", "Backspace", "Tab", "KeyQ", "KeyW", "KeyE", "KeyR", "KeyT", "KeyY", "KeyU", "KeyI", "KeyO", "KeyP", "BracketLeft", "BracketRight", "Backslash", "CapsLock", "KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyH", "KeyJ", "KeyK", "KeyL", "Semicolon", "Quote", "Enter", "ShiftLeft", "KeyZ", "KeyX", "KeyC", "KeyV", "KeyB", "KeyN", "KeyM", "Comma", "Period", "Slash", "ArrowUp", "ShiftRight", "ControlLeft", "MetaLeft", "AltLeft", "Space", "AltRight", "ControlRight", "ArrowLeft", "ArrowDown", "ArrowRight"];
document.onkeydown = function (event) {
  if (arrayOfBtnCodes.includes(event.code)){
...
function inputToTextarea(div, val){
    ...
    if(val == 'Shift'){
        shiftCount++;
        if(shiftCount%2 == 1){
          document.querySelectorAll(".shiftLed").forEach(el => {el.classList.remove("hidden")})
          ...
          document.querySelectorAll(".shiftLed").forEach(el => {el.classList.add("hidden")})
            document.querySelectorAll('span').forEach(el => {
                el.classList.add('hidden')
